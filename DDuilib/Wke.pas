...
type
  ...
  private
    ...
    // procedure __paint(p1, p2: Pointer; bits: Pointer; pitch: Integer); virtual; abstract;
    procedure __paint(p1, p2: Pointer; pitch: Integer; bits: Pointer); virtual; abstract;
  ...
  public
    ...
    procedure paint(bits: Pointer; pitch: Integer);
...
procedure IWebView.paint(bits: Pointer; pitch: Integer);
begin
